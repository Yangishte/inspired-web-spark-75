...
import bgRoom from "@/assets/backgrounds/bar-a-custom-room.png";


const TOTE_BAG_URL = "/models/jute-tote-bag.glb";
const WM604_URL = "/models/wm604-tote-bag.glb";
const WM110_URL = "/models/wm110-drawstring-bag.glb";
const WM101_URL = "/models/wm101-canvas-tote.glb";
const WM880_URL = "/models/wm880-beige-backpack.glb";
const WM552_URL = "/models/wm552-beige-zippered-pouches.glb";
const WM540_URL = "/models/cream-fabric-pouches.glb";
